		...
		slimScroll : function(h) {
			...
			this.each(function() {
				...
				function m(d, f, h) {
					...
					e = l * (b[0].scrollHeight - b.outerHeight());h && (e = d, d = e / b[0].scrollHeight * b.outerHeight(), d = Math.min(Math.max(d, 0), g), c.css({
						top : d + "px"
				...
				if (b.parent().hasClass(a.wrapperClass)) {
					...
					g.css(q);c.css(q);b.wrap(n);b.parent().append(c);b.parent().append(g);a.railDraggable && c.bind("mousedown", function(a) {
						...
						pageY = a.pageY;b.bind("mousemove.slimscroll", function(a) {
